...
The package is published at <https://www.npmjs.com/package/liquid-potassium/v/0.3.0>.
...
Version `0.3.0` includes built runtime files for the OpenClaw entrypoints and kChat WebSocket helpers, so imports such as `liquid-potassium/openclaw/tools` work without install-time build scripts.
